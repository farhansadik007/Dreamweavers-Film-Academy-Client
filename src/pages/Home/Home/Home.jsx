    ...
    return (
        <div>
            ...
            <div className="grid justify-items-center gap-4 my-36">
                <h2 className="text-9xl flex"><a href="https://en.wikipedia.org/wiki/Film" target="blank"><FaWikipediaW size={140} /></a>hat is a Film<span className="text-red-500">?</span></h2>

                <p className="w-6/12 text-2xl mt-12">A <span className="text-red-500">film</span> also called a movie, motion picture, moving picture, picture, photoplay or (slang) flick – is a work of visual art that simulates experiences and otherwise communicates ideas, stories, perceptions, feelings, beauty, or atmosphere through the use of moving images. These images are generally accompanied by sound and, more rarely, other sensory stimulations. The word &quot;cinema&quot;, short for cinematography, is often used to refer to filmmaking and the film industry, and to the art form that is the result of it.</p>

                <h2 className="text-9xl flex my-36"><span className="text-red-500">!!!</span>Facts<span className="text-red-500">!!!</span></h2>

                <p className="w-6/12 text-2xl">
                    <p className="my-20">The first cinemas were opened in the early <span className="text-red-500">1900s</span>. Before then, films were shown in public halls, theatres or at funfairs!</p>
